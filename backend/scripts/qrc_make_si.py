...
table(["Setting", "NARMA", "Weather"],
      [["Reservoir", "crotonic9 (Table S1/S2)", "crotonic9 (Table S1/S2)"],
       ...
       ["Reservoir wall time", "≈4.0 h", "≈4.4 h"],
       ["Seed", "42", "42"]],
